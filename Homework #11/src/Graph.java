...
/**
 * Graph class.  Holds functions to interact with the graph.
 * 
...
public class Graph {
     ...
     */
    public static boolean isInGraph(Map<String, Node> graph, String nodeName) {
     ...
     * 
     */
    public static void displayShortestPath(Map<String, Node> graph,
        ...
        dijkstra(graph, startNode, distance, predecessors);
     ...
     */
    private static void dijkstra(Map<String, Node> graph,
                                 Node startNode,
     ...
     */
    private static Node dequeueMin(List<Node> priorityQ,
                                   Map<Node, Integer> distance) {
